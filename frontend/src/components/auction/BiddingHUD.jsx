    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col gap-2 rounded-xl p-6 bg-[#39282b] border border-white/5 relative overflow-hidden group">
                ...
                <p className="text-[#ba9ca1] text-sm font-medium uppercase tracking-wider">{t('auction.currentBid')}</p>
                <div className="flex items-baseline gap-2">
                    <p className="text-white tracking-tight text-4xl font-black leading-tight">€{currentPrice}</p>
            ...
            <div className="flex flex-col gap-2 rounded-xl p-6 bg-primary/10 border border-primary/30">
                <p className="text-primary text-sm font-bold uppercase tracking-wider">{t('auction.endsIn')}</p>
