...
const LiveAuctionVideo = () => {
    ...
    const wsUrl = 'ws://localhost:8080/bidding/'; // En producción usar env var
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark font-display text-white overflow-hidden h-screen flex flex-col relative">
            <ViewerHeader />
                ...
                <div className="lg:col-span-8 flex flex-col h-full overflow-y-auto custom-scrollbar bg-background-light dark:bg-background-dark">
                    <div className="relative">
                        ...
                        {isSeller && !isEnded && (
                            <button
                                onClick={endAuction}
                                className="absolute top-4 right-4 z-40 bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-full font-bold shadow-lg shadow-red-600/20 transform hover:scale-105 transition-all flex items-center gap-2"
                            >
